...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(
            ":/icon_b/assets/svg_blue/xing.svg", QSize(), QIcon.Normal, QIcon.Off
        )
        ...
        sizePolicy.setHeightForWidth(
            self.left_menu_frame.sizePolicy().hasHeightForWidth()
        )
        ...
        self.left_column_frame.setObjectName("left_column_frame")
        ...
        sizePolicy1.setHeightForWidth(
            self.content_frame.sizePolicy().hasHeightForWidth()
        )
        ...
        self.page_stacked.setObjectName("page_stacked")
        ...
        self.setting_container.setStyleSheet("")
