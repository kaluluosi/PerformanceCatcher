...
"")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icon_w/assets/svg_white/file-excel.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon3.addFile(u":/icon_b/assets/svg_blue/file-excel.svg", QSize(), QIcon.Normal, QIcon.On)
