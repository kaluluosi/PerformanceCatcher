...
"")
        ...
        sizePolicy1.setHeightForWidth(self.le_tag.sizePolicy().hasHeightForWidth())
        self.le_tag.setSizePolicy(sizePolicy1)
        ...
        brush11 = QBrush(QColor(39, 44, 54, 255))
...
#endif
        self.btn_save.setPalette(palette2)
        icon1 = QIcon()
...
#endif
        self.btn_empty.setPalette(palette3)
        icon2 = QIcon()
...
#endif
        self.tableView.setPalette(palette4)
