...
class Ui_Logcat(object):
    def setupUi(self, Logcat):
        ...
        brush2 = QBrush(QColor(51, 54, 66, 255))
        brush2.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Light, brush2)
        brush3 = QBrush(QColor(42, 45, 55, 255))
        brush3.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Midlight, brush3)
        brush4 = QBrush(QColor(17, 18, 22, 255))
        brush4.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Dark, brush4)
        brush5 = QBrush(QColor(23, 24, 29, 255))
...
"")
        ...
        brush12 = QBrush(QColor(27, 30, 35, 255))
        ...
        self.adaptive = QPushButton(Logcat)
        ...
        self.tableView = QTableView(Logcat)
