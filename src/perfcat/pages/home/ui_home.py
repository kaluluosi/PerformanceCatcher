...
class Ui_Home(object):
    def setupUi(self, Home):
        ...
        Home.resize(500, 336)
        icon = QIcon()
        icon.addFile(u":/icon_w/svg_white/home.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon.addFile(u":/icon_b/svg_blue/home.svg", QSize(), QIcon.Normal, QIcon.On)
...
"background-image: url(:/images/images/logo_sws_10.png);\n"
